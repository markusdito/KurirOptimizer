...
/**
 * Kelas GUI yang digunakan untuk menampilkan peta serta pilihan kota asal.
 * Interaksi pada kelas ini akan mengisi kota asal pada frame utama.
 *
 * @author <a href="https://github.com/vianneynara">Nara</a>
 * */

public class SelectOriginDialog extends javax.swing.JDialog {
    private MainFrame mainFrame;

    /**
     * Creates new form SelectOriginDialog
     */
    public SelectOriginDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     * tersebut, maka akan diset kota asalnya dengan nama label yang diberikan.
     * */
    private void checkSet(String cityName) {
        if (mainFrame.isCurrentOrigin(cityName)) {
            ...
            mainFrame.setCurrentOrigin(cityName);
        }
        dispose();
    }
